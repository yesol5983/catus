      ...
      <div style={{ paddingTop: '20px', paddingBottom: '20px', paddingLeft: '20px', paddingRight: '20px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div className="bg-[white]" style={{ borderRadius: '16px', paddingTop: '8px', paddingBottom: '8px', paddingLeft: '16px', paddingRight: '16px', marginBottom: '8px' }}>
              {/* 닉네임 변경 */}
              <div className="flex justify-between items-center cursor-pointer transition-all active:scale-98" style={{ paddingTop: '16px', paddingBottom: '16px', borderBottom: expandedItems.nickname ? '1px solid #f0f0f0' : 'none' }} onClick={() => toggleItem('nickname')}>
